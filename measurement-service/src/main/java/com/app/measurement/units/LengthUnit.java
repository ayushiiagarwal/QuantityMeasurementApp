...
public enum LengthUnit implements IMeasurable {
    ...
    @Override public double convertToBase(double value)   { return value * convertToFeet; }
    @Override public double convertFromBase(double value) { return value / convertToFeet; }
    @Override public double getConversionFactor()         { return convertToFeet; }
